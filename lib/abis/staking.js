const ABI = [
  {
    inputs: [
      { internalType: "address", name: "_apeCoinContractAddress", type: "address" },
      { internalType: "address", name: "_baycContractAddress", type: "address" },
      { internalType: "address", name: "_maycContractAddress", type: "address" },
      { internalType: "address", name: "_bakcContractAddress", type: "address" },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "address", name: "user", type: "address" },
      { indexed: false, internalType: "uint256", name: "amount", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "mainTypePoolId", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "mainTokenId", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "bakcTokenId", type: "uint256" },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: "uint256", name: "poolId", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "lastRewardedBlock", type: "uint256" },
    ...
    outputs: [
      {
        components: [
          ...
          {
            components: [
              { internalType: "uint256", name: "startTimestampHour", type: "uint256" },
              { internalType: "uint256", name: "endTimestampHour", type: "uint256" },
  ...
  },
  {
    ...
    name: "pools",
    outputs: [
      { internalType: "uint256", name: "lastRewardedTimestampHour", type: "uint256" },
      { internalType: "uint256", name: "lastRewardsRangeIndex", type: "uint256" },
      { internalType: "uint256", name: "stakedAmount", type: "uint256" },
