export default function Head() {
  return (
    <>
      <title>ApeCoin UI - Easy and open-source user interface for ApeCoin Staking</title>
      <meta
        name="description"
        content="ApeCoin staking through an alternative open-source UI that's globally available."
      />
      <meta
        property="og:title"
